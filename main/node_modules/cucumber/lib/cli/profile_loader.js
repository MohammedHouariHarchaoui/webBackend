...
import _stringArgv from 'string-argv';
...
var ProfileLoader = function () {
  ...
  (0, _createClass3.default)(ProfileLoader, [{
    ...
    key: 'getArgv',
    value: function () {
      var _ref2 = (0, coroutine)(function* (profiles) {
